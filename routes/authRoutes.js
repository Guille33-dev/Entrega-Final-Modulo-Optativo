...
router.post("/refresh", async (req, res) => {
  try {
    ...
    const user = await User.findById(payload.sub).select("+refreshToken username roles active");

    if (!user || !user.active || !user.refreshToken || user.refreshToken !== refreshToken) {
